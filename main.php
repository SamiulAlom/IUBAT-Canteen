...
<html lang="en">
  ...
  -->
    <link
      rel="preload"
      as="image"
      href="./assets/images/hero-banner.png"
      media="min-width(768px)"
    />
    <link
      rel="preload"
      as="image"
      href="./assets/images/hero-banner-bg.png"
      media="min-width(768px)"
    />
  ...
  -->
    ...
    <header class="header" data-header>
      <div class="container">
        <h1>
          <a href="#" class="logo">ICanteen<span class="span">.</span></a>
        </h1>
        ...
        <nav class="navbar" data-navbar>
          <ul class="navbar-list">
            ...
            <li class="nav-item">
              <a href="home.php" class="navbar-link" data-nav-link>Update Info</a>
            </li>
          </ul>
        </nav>
        ...
        <div class="header-btn-group">
          ...
          <a href="index.php">
            <button class="btn btn-hover">Log Out</button>
          </a>
        ...
        >
          <div class="container">
            ...
            ?>
              ...
              <p class="hero-subtitle">Welcome to IUBAT Canteen <b><?php echo $res_Uname ?></b></p>
                  ...
                  <div class="card-content">
                    ...
                    <h3 class="h3">
                      <a href="#" class="card-title"
                        >What Do You Think About Cheese Pizza Recipes?</a
                      >
                    </h3>
      ...
      >
        <div class="container">
          ...
          <ul class="footer-list">
            ...
            <li>
              <p class="footer-list-item">01641621311</p>
            </li>

            <li>
              <p class="footer-list-item">samiulalom090@.com</p>
            </li>
      ...
      <div class="footer-bottom">
        <div class="container">
          <p class="copyright-text">
            &copy; 2024 <a href="#" class="copyright-link">Samiul Alom</a> All
            Rights Reserved.
          </p>
        </div>
      </div>
